...
public class SwerveSubsystem extends SubsystemBase
{
	...
	private ChassisSpeeds   autonCachedChassisSpeeds = new ChassisSpeeds();
	private DriveFeedforwards autonCachedFeedForwards;
	...
	public void periodic()
	{
		...
		if(DriverStation.isAutonomous()){
			if(useAutonSteeringIntercept.getAsBoolean()){
				autonCachedChassisSpeeds.omegaRadiansPerSecond = autonSteeringInterceptRPS.getAsDouble();
			}
			
			if (Constants.AutonConstants.ENABLE_FEED_FORWARDS && autonCachedFeedForwards!=null) {
				swerveDrive.drive(
						autonCachedChassisSpeeds,
						swerveDrive.kinematics.toSwerveModuleStates(autonCachedChassisSpeeds),
						autonCachedFeedForwards.linearForces());
			} else {
				swerveDrive.setChassisSpeeds(autonCachedChassisSpeeds);
			}
		}
	}
		...
		try
		{
			...
			AutoBuilder.configure(
					...
					(speedsRobotRelative, moduleFeedForwards) -> {
						autonCachedChassisSpeeds=speedsRobotRelative;
						autonCachedFeedForwards=moduleFeedForwards;
